    ...
    <main className="bg-gray-50 text-gray-800">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between p-8 bg-gradient-to-r from-blue-100 to-white">
        <div className="md:w-1/2">
          ...
          >
            Especialista en cirugía de columna vertebral y técnicas mínimamente invasivas en Cancún. Con más de 15 años de experiencia ayudando a pacientes nacionales e internacionales.
          </motion.p>
          <motion.a
            href="#contacto"
            initial={{ opacity: 0 }}
